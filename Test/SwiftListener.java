...
public interface SwiftListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterExplicit_member_expression4(SwiftParser.Explicit_member_expression4Context ctx);
	/**
	 * Exit a parse tree produced by the {@code explicit_member_expression4}
	 * labeled alternative in {@link SwiftParser#postfix_expression}.
	 * @param ctx the parse tree
	 */
	void exitExplicit_member_expression4(SwiftParser.Explicit_member_expression4Context ctx);
	/**
